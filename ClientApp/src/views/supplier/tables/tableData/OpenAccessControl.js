...
const AccessControlSupplier = (props) => {
        ...
        <div>
            ...
            <Modal backdrop="static" isOpen={is_open} toggle={() => setis_open(false)} className='modal-md modal-dialog-centered'>   {/*abhishek 17-2-22*/}
                ...
                <Form onSubmit={onSubmit}>
                    <ModalBodyUI supplierData={props.supplierData} setRole={setRole} bodyFor="AccessControlSupplier" />
...
export default AccessControlSupplier
