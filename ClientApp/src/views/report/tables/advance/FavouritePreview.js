...
const FavouritePreview = (data) => {
  const [isOpen, setis_open] = useState(false)
  console.log(data)
  return (    
    <div>
      <div id="InvoiceCardFav">
      {/* Address and Contact */}    
          ...
          <div className="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
            <div>
             <Button.Ripple color='secondary btn-sm'>
                <Home size={14} />
                <span className='align-middle ml-25' onClick={() => data.setOpen(false)}>Back to Favourites</span>
              </Button.Ripple>
            </div>
            <div className="my-3">
              ...
              <h4 className="text-center invoice-title">Favourite Report </h4>
            </div>
        ...
        <CardBody className="p-0">
          <Table responsive>
            <tr>
              ...
              <td className="py-1">
                <span className="font-weight-normal">null</span>
              </td>
              <th className="py-1">
                <span className="font-weight-bold">Wishlist Name</span>
              </th>
              <td className="py-1">
              ...
              <td className="py-1">
                <span>
                  <table>
                    <tbody>
                      <tr>
                        <td className="pr-1 border-0 font-weight-bold pl-0">
                          Finish:
                        </td>
                      ...
                      <tr>
                        <td className="pr-1 border-0 font-weight-bold pl-0">GSM:</td>
