...
// The protype of the object returned from the JsBarcodeNew() call
...
var JsBarcodeNew = function JsBarcodeNew(element, text, options) {
	var api = new API();
...
JsBarcodeNew.getModule = function (name) {
...
// Added to the api by the JsBarcodeNew function
...
// Initialize JsBarcodeNew on all HTML elements defined.
...
if (typeof window !== "undefined") {
	window.JsBarcodeNew = JsBarcodeNew;
}

// Export to jQuery
/*global jQuery */
if (typeof jQuery !== 'undefined') {
	jQuery.fn.JsBarcodeNew = function (content, options) {
		var elementArray = [];
		jQuery(this).each(function () {
			elementArray.push(this);
		});
		return JsBarcodeNew(elementArray, content, options);
	};
}

// Export to commonJS
module.exports = JsBarcodeNew;
...
function getOptionsFromElement(element) {
	...
	for (var property in _defaults2.default) {
		if (_defaults2.default.hasOwnProperty(property)) {
			// JsBarcodeNew-*
			if (element.hasAttribute("JsBarcodeNew-" + property.toLowerCase())) {
				options[property] = element.getAttribute("JsBarcodeNew-" + property.toLowerCase());
			}
	...
	options["value"] = element.getAttribute("JsBarcodeNew-value") || element.getAttribute("data-value");
...
var SVGRenderer = function () {
	...
	_createClass(SVGRenderer, [{
		...
		value: function setSvgAttributes(width, height) {
			...
			svg.setAttribute("width", "190px"); //sanket
			// svg.setAttribute("height", "75px"); //sanket
			// svg.setAttribute("margin-top", "-10px"); //sanket
		...
		value: function drawRect(x, y, width, height, parent) {
			...
			// rect.setAttribute("height", '25px'); //sanket
