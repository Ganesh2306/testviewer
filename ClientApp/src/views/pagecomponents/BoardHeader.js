...
import { Button, UncontrolledButtonDropdown, DropdownItem, DropdownToggle, DropdownMenu, Row, Col } from 'reactstrap'
import { Trash, File, FolderPlus, Plus, ShoppingCart, X } from 'react-feather'
...
const BoardHeader = (props) => {
    ...
    //const Createboardtoggle = () => setCreateboard(!Createboard)
    ...
    const CreateOpentoggle = () => setis_createopen(!is_createopen)
     return (
        ...
        <Row className='row_search boardheader'>
                <Col className='py-1 mysearch_head d-flex justify-content-between'>
                    <div className='left-heading w-50'>                      
                        <h6 className='m-0'>aaa</h6>
                    ...
                    <div className="p-0 mt-0 text-right d-flex col-lg-6 right-text-heading" style={{ justifyContent: 'right' }}>
                                ...
                                <UncontrolledButtonDropdown className="mr-50">
                                    ...
                                    board 3
                                        ...
                                        {/* comment by rinku */}
                                        <ModalSaveWishlist is_open={is_open} setis_open={setis_open}/>
                                    </DropdownMenu>
