...
export const ImageSearch = (props) => {
    ...
    // async function getSupCustConfiguration() {
    ...
    //     try {
    //         const response = await axios.post(`./DesignSearch/GetCommonSupCustConfiguration_AI`, GetSupCustConfigurationRequestDto)
    //         const res = JSON.parse(response.data)// No need to parse if response.data is already an object
