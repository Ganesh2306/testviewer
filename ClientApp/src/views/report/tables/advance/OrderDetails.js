...
// ** Store & Actions
import { serverSideColumns, OrderData } from './data'
            ...
            <Card>
             ...
             <CardTitle tag='h4'>Order List</CardTitle>  
                <div className='d-flex align-items-center mb-sm-0 mb-1 mr-1 excelpdf_group'>
                      <Button.Ripple color='btn btn-sm btn-success text-right mr-1'>                
                      <span className='ml-25'>Save Excel</span>
                      </Button.Ripple>  
                      <Button.Ripple color='btn btn-sm btn-success text-right'>                
