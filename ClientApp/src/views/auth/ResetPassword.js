          ...
          <CardBody>
            ...
            <Form className='auth-reset-password-form mt-2' onSubmit={e => e.preventDefault()}>
              <FormGroup>
                ...
                <InputPassword innerRef={register({ required: true })} invalid={errors.password_hash && true} className='input-group-merge' name="password_hash" id='new-password' autoFocus />
              ...
              <FormGroup>
                ...
                <InputPassword innerRef={register({ required: true })} invalid={errors.passwordConfirmation && true} name="passwordConfirmation" className='input-group-merge' id='confirm-password' />
