...
(function($, window, document) {
  var EZP = {
    ...
    startZoom: function() {
      ...
      // surya changes 05/04/2023
      self.zoomLock = 1;
      //self.zoomLock=0.333333333333; commented
      self.scrollingLock = false; 
      self.changeBgSize = false;
      //self.currentZoomLevel = self.options.zoomLevel; //com by avi to check
      self.currentZoomLevel =0.333333333333; //commented//uncommented by avinash
      ...
      // surya changes 05/04/2023
      //self.imageRatioX = 229 / self.largeWidth;
      //self.imageRatioY = 234/ self.largeHeight;
      ...
      self.bgSizeX = self.scaleRatioX * self.largeWidth; //avi com to check
      self.bgSizeY = self.scaleRatioY * self.largeHeight; //avi com to check
     // surya changes 05/04/2023   
      //self.bgSizeX=687;
      //self.bgSizeY=702;

      //self.zoomPercentage = 1;s
      //self.setCenterPosition = false;

        // surya changes 26/04/2023
        if ($('#_zoomImage1').hasClass('flag')) { // avi com to check
        self.zoomWindow.css('background-repeat', 'no-repeat');// avi com to check
        } else { //avi com to check
       self.bgSizeX=self.scaleRatioX * self.largeWidth * 3;    // surya changes for 300% zoom// new chn by avinash
       self.bgSizeY= self.scaleRatioY * self.largeHeight * 3;  // surya changes for 300% zoom // new chn by avinash
  
 
 
       self.zoomPercentage = 1;// new chn by avinash
      ...
      if (self.options.zoomType === 'window' || self.options.zoomType === 'inner') {
        ...
        if (self.options.easing) {
          ...
          //self.zoomWindow.css('background-repeat','repeat');
            ...
            // surya changes 26/04/2023
             if ($('#_zoomImage1').hasClass('flag')) {//com by avi to check
                 self.zoomWindow.css('background-repeat', 'no-repeat');//com by avi to check
             } else {
                if (self.options.repeatBG) {
                    self.zoomWindow.css('background-repeat', 'repeat');
                } else {
