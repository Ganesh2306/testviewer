...
function setClickEvents() {
    ...
    $("#hDensity").keyup(function(){
        //var flag = floatValide($('#hDensity').val())
    ...
    $("#ssWidth").keyup(function(e){
        var flag = floatValide($('#ssWidth').val());
        if(flag) {
            var ssWidth = $('#ssWidth').val();
        if (ssWidth.toString() != "NaN") {
            ...
            ssWidthC($('#ssWidth').val().slice(0, -1))
        }
    ...
    $("#ssHeight").keyup(function(){
        var flag = floatValide($('#ssHeight').val());
        if(flag) {
        var ssHeight = $('#ssHeight').val();
