...
// ** Table Columns
import { CustomerTableColumns } from '../data'
import AddCustomer from './OpenAddCustomer'
// ** Store & Actions
import { getData, getDataSearch } from '../../store/actions'
  ...
  // ** Custom Pagination
    const CustomPagination = () => {
       ...
       // const perpagEntries = Ispaging === true ? 200 : rowsPerPage
        ...
        return (
            <div className="pagi_custom" style={{height:'55px', right:'1.8rem' }}>
      <ReactPaginate
        previousLabel={''}
        nextLabel={''}
        breakLabel='...'
      ...
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Customer List</CardTitle>
              ...
              <Col className='mx-0 mt-1 d-flex mb-50'>
          <Col sm=''>
