...
import ModalBodyDesignGroup from '../ModelBodyDesignGroup'
...
const EditGroup = (props) => {
  ...
  {/* <Edit size={15} onClick={ () => setis_open(true)}/> */}
    ...
    <ModalHeaderUI setis_open={setis_open} headerName="Edit Group"/>
    <Form onSubmit={(e) => {
    ...
    <ModalBodyDesignGroup bodyFor="Update" editName = "Update" editLabelName="Edit Design Group" />
