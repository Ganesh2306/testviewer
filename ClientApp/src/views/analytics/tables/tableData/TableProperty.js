...
// ** Table Columns
import { AnalyticPropertyColumn, PropertyData } from './data'
...
import AddRemoveProp from './OpenAddRemove'


const DataTableProperty = () => {
  // ** Store Vars
    ...
    <Fragment>
      <Card>
        ...
        <DataTable
          ...
          columns={AnalyticPropertyColumn}
...
export default memo(DataTableProperty)
