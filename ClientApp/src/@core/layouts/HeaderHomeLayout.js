...
import NavbarComponent from './components/navbar/LandingNav'
                        ...
                        <ul className='nav navbar-nav'>
                            <NavItem>
                                  <Link to = {localStorage.getItem("IsSingleCategory") === "true" ? "/SupplierList" : "/brandingpage"}   className='navbar-brand'>
                                    ...
                                    {/*<h2 className='brand-text mb-0'>{themeConfig.app.appName}</h2> src={(JSON.parse(localStorage.userData).organisationId === 757782875) ? clientLogo : themeConfig.app.appLogoImage}}*/}
                                </Link>
                            </NavItem>
                        </ul>
                    </div>
