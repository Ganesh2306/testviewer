...
import NavbarComponent from './components/navbar/SeasonNavbar'
                    ...
                    {!navbar && (
                        <div className='navbar-header d-xl-block d-md-block'>
                            <ul className='nav navbar-nav'>
                                <NavItem>
                                {/* seasonBook Page Redirect added working Tanmay 17-04-2024 purpose :- redirect Home page (SupplierList) */}
                                    <Link to='/SupplierList' className='navbar-brand'>
