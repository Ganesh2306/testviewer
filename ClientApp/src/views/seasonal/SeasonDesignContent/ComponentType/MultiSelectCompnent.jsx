...
<div class="form-check-inline">
    <label>{props.label}</label>
        ...
        options={props.option} onChange={onCountryChange} optionLabel="design_featuretype_name" filter  filterBy="design_featuretype_name" placeholder="Select a Options"
...
export const SelectProGroup = (props) => {
    ...
    useEffect(() => {
        axios.get(`Design/GetProductList`).then((e) => {
    ...
    return (
        <div className="multiselect-demo">
            <div className="card">   
                <MultiSelect appendTo='self' value={selectedprlist} options={product} onChange={(e) => {
                    let str = ""
                    if (e.value.length > 1) {
                        e.value.forEach((n, k) => {
            ...
            } optionLabel="name" placeholder="Select" maxSelectedLabels={1000000}
                />
