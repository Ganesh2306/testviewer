          ...
          <div className="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
            <div>
             <Button.Ripple color='secondary btn-sm'>
                <Home size={14} />
                <span className='align-middle ml-25' onClick={() => data.setOpen(false)}>Back to Cart</span>
              </Button.Ripple>
            </div>
            <div className="my-3">
              ...
              <h4 className="text-center invoice-title">Cart Report </h4>
            </div>
        ...
        <CardBody className="p-0">
          <Table responsive>
            <tr>
              ...
              <th className="py-1">
                <span className="font-weight-bold">Cart Name</span>
              </th>
              <td className="py-1">
            ...
            <tr>
              ...
              <td className="py-1">
                <span className="font-weight-normal">0</span>
              </td>
              <td className="py-1">
