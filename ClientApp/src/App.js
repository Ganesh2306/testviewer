...
const Newapp = () => {
    ...
    console.info('%cARCHIVE_VIEWER v 0.86 15-07-2025', 'background: #222; color: #bada55')
    console.info(`%cARCHIVE_VIEWER v ${packageJson.version}`, 'background: #222; color: #bada55');
