...
// ** Table Columns
import { AnalyticLogColumn, LogData } from './data'
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Activity Logs</CardTitle>
          <div className="col-md-5 pull-right" style={{position:"absolute", top:"16px", right:"18px", display:"inline-flex"}}>
               ...
               <Button color='success' className="btn ml-1">
                  Save PDF
               </Button>
            </div>
        </CardHeader>
...
export default memo(DataTableAnalytic)
