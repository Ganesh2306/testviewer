...
// ** Table Columns
import { OrgnizationRequestTableColumns } from '../data'
//import OpenAddOrganization from './OpenAddOrganization'
// ** Store & Actions
import { getOrgRequest, getOrgRequestSearch} from '../store/actions'
...
const OrgnizationList = () => {
  ...
  const dispatch = useDispatch()
    const store = useSelector(state => state.orgRequest)
  // ** States
    ...
    <Fragment>
      <Card>
        ...
        <DataTable
          ...
          columns={OrgnizationRequestTableColumns}
