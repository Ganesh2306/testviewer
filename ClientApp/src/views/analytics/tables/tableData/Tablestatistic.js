...
// ** Table Columns
import { StatisticColumn, StatisticData } from './data'
    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Design Statistic</CardTitle>
          <div className="col-md-8 pull-right" style={{position:"absolute", top:"16px", right:"18px", display:"inline-flex"}}>
                ...
                <Col className="form-group mb-0">                   
                   <SelectCustomer className="w-100"/> 
                </Col>
                <Col className="form-group mb-0 ">                   
                <SelectRegion/> 
                </Col>              
...
export default memo(DataTableStatistic)
