...
// ** Store & Actions
import { serverSideColumnsCart, CartData } from './data'
       ...
       <div className='report_details'>
            <Card>
              {/* <CardHeader className='border-bottom d-flex'>
                <CardTitle tag='h4'>Cart List</CardTitle> 
                <div className="col-md-4 text-left">
                <Col className="form-group d-flex">
                     <Label className="col-form-label col-md-4">Customer</Label>
                     <Input type="select" name="CartCName" className="states order-alpha form-control state col-md-8" parentid="#" subid="#" id="">
