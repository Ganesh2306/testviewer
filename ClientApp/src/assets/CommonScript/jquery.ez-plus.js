...
(function ($, window, document, undefined) {
    var EZP = {
        init: function (options, elem) {
            ...
            // self.imageSrc = self.imageSrc.replace("t.", "z.");
            // self.imageSrc = self.imageSrc.replace("/t/", "/z/");
        ...
        fetch: function (imgsrc) {
            ...
            if (imgsrc != undefined) {
                ...
                //thumbImg.src = self.imageSrc
                thumbImg.src = imgsrc.replace("z.", "t.");
                thumbImg.src = thumbImg.src.replace("/z/", "/t/");
            }
            return;
        },
        ...
        startZoom: function () {
            ...
            self.zoomContainer =
                $('<div class="zoomContainerLens" ' +
                    ...
                    'style="' +
                    'position:absolute;' +
                    'margin-left:' + (self.options.windowOffsetLeft) + ';' +
                    'margin-top:' + (self.options.windowOffsetTop) + ';' +
                    'height:' + self.nzHeight + 'px;' + '' +
                    'width:' + self.nzWidth + 'px;' +
            ...
            self.zoomWindow = $('<div style="z-index:999;' +
                'margin-left:' + (self.options.windowOffsetLeft) + 'px;' +
                'margin-top:' + (self.options.windowOffsetTop) + 'px;' + self.zoomWindowStyle + '" class="zoomWindow">&nbsp;</div>')
                .appendTo(targetZoomContainer.parent().parent().parent()).click(function () {
