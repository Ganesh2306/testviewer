...
// ** Table Columns
import { RoleTableColumns } from './data'

// ** Store & Actions
import { getRolesData, getRolesDataSearch } from '../../store/actions'
    ...
    const CustomPagination = () => {
        ...
        return (
            <ReactPaginate
                ...
                containerClassName={
                    'pagination react-paginate separated-pagination pagination-sm '     //abhishek 1-03
                }
            />
        )
    }
