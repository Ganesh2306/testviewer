...
import ShareDesignAccordion from '../tableData/ShareDesignAccordion'
// import "./share.css"
...
const ModalBodyUIC = (props) => {
  ...
  return (
    < ModalBody> 
       <ShareDesignAccordion reference={props.reference} customerId = {props.customerId} SupplierId={props.SupplierId} /> 
    </ModalBody>
  )
}

export default ModalBodyUIC
